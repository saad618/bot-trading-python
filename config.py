...
class Settings:
    ...
    BUY_SCORE_THRESHOLD = int(os.getenv("BUY_SCORE_THRESHOLD", "4").strip().lstrip("=").strip() or "4")
    SELL_SCORE_THRESHOLD = int(os.getenv("SELL_SCORE_THRESHOLD", "-3").strip().lstrip("=").strip() or "-3")
    ...
    MAX_OPEN_POSITIONS    = int(os.getenv("MAX_OPEN_POSITIONS", "6").strip().lstrip("=").strip() or "6")
    ...
    DISABLE_TREND_FILTER = os.getenv("DISABLE_TREND_FILTER", "false").strip().lstrip("=").strip().lower() == "true"
